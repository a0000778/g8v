...
{//背景地圖
	...
	function mapMark(name,pos,mod,args,formServer){
	...
	function mapUnMark(name,formServer){
		let mark=markList.get(name);
		if(!mark) return;
